...
export default function App(){
  ...
  return <div className={`app ${dark?'dark':''}`}>
    ...
    <main className="main">
      ...
      {tab==='practice' && <PracticePanel q={practiceQ} list={filtered} current={current} setCurrent={setCurrent} answer={answerPractice} selected={practiceQ && revealedPractice[practiceQ.id] ? answers[practiceQ.id] : null} toggleBookmark={toggleBookmark} bookmarks={bookmarks} query={query} setQuery={setQuery} domain={domain} setDomain={setDomain} difficulty={difficulty} setDifficulty={setDifficulty} mode={mode} setMode={setMode} domains={domains}/>} 
